...
ALTER TABLE `attribute` ADD `siteguid` varchar(255) null after `name`, ADD `sflag` tinyint(1) not null default '0' after `siteguid`, ADD `lflag` tinyint not null default '0' after `sflag`;
...
ALTER TABLE `attributed_stock` ADD `siteguid` varchar(255) null after `price`, ADD `sflag` tinyint(1) not null default '0' after `siteguid`, ADD `lflag` tinyint not null default '0' after `sflag`;
...
ALTER TABLE `orders` ADD `siteguid` varchar(255) null after `completetime`, ADD `sflag` tinyint(1) not null default '0' after `siteguid`, ADD `lflag` tinyint not null default '0' after `sflag`;
...
ALTER TABLE `stockdiary` ADD `siteguid` varchar(255) null after `supplierdoc`, ADD `sflag` tinyint(1) not null default '0' after `siteguid`, ADD `lflag` tinyint not null default '0' after `sflag`;
