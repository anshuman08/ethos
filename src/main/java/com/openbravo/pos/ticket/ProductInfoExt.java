...
public class ProductInfoExt {
    ...
    private Map<AttributedProductStock, List<AttributedProductStockAttribute>> productStockAttributess;
    ...
    public ProductInfoExt() {
        ...
        imgurl = null;
        description = null;
        productStockAttributess = new HashMap<>();
        siteguid = null;
    }

    public Map<AttributedProductStock, List<AttributedProductStockAttribute>> getProductStockAttributess() {
        return productStockAttributess;
    }
