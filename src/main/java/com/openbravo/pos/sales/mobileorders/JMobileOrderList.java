 ...
 * @author JG uniCenta
 */
public class JMobileOrderList extends javax.swing.JDialog {
    
    private String m_sDialogTicket, customername;
    
    /** Creates new form JTicketsBagSharedList */
    private JMobileOrderList(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }
    /** Creates new form JTicketsBagSharedList */
    private JMobileOrderList(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    }
     ...
     * @return
     */
    public String showTicketsList(java.util.List<MobileAppInfo> atickets, DatalogicMobileAppSales dlMobile) {
// JG Dec 2014
 MobileAppInfo m_Ticket = null;
        
        for (MobileAppInfo aticket : atickets) {
            m_jtickets.add(new JButtonTicket(aticket, dlMobile));
        }  
        ...
        if (lsize > 0) {
            ...
            JOptionPane.showMessageDialog(this,
                AppLocal.getIntString("message.nomobiletickets"), 
                AppLocal.getIntString("message.mobiletickettitle"), 
     ...
     * @return
     */
    public static JMobileOrderList newJDialog(JTicketsBagShared ticketsbagshared) {
        
        Window window = getWindow(ticketsbagshared);
        JMobileOrderList mydialog;
        if (window instanceof Frame) { 
            mydialog = new JMobileOrderList((Frame) window, true);
        } else {
            mydialog = new JMobileOrderList((Dialog) window, true);
        } 
    ...
    public static JMobileOrderList newJmapDialog(JTicketsBagRestaurantMap ticketsbagresturant) {
        
        Window window = getWindow(ticketsbagresturant);
        JMobileOrderList mydialog;
        if (window instanceof Frame) { 
            mydialog = new JMobileOrderList((Frame) window, true);
        } else {
    ...
    private class JButtonTicket extends JButton {
        ...
        private final MobileAppInfo m_Ticket;
        
        public JButtonTicket(MobileAppInfo ticket, DatalogicMobileAppSales dlReceipts){
...
// JG Nov 2014
            String total = ticket.getTotal_value().toString();
//            try {
...
//        }
            ...
            setText(ticket.getOrderType()+ " - "+ticket.getAppName()+ " - "+ticket.getOrderNo()+ " - " + total);            
        }
        ...
        private class ActionListenerImpl implements ActionListener {
            ...
            public void actionPerformed(ActionEvent evt) {
                m_sDialogTicket = m_Ticket.getOrderNo();
                JMobileOrderList.this.setVisible(false);
