 ...
 * @author JG uniCenta
 */
public class JEmptyTableList extends javax.swing.JDialog {
    
    private Place m_sDialogTicket;
    
    /** Creates new form JTicketsBagSharedList */
    private JEmptyTableList(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }
    /** Creates new form JTicketsBagSharedList */
    private JEmptyTableList(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    }
     ...
     * @return
     */
    public Place showTicketsList(java.util.List<Place> mPlaces, DataLogicSales dlsales) {
// JG Dec 2018
        Place m_Place = null;
        
        mPlaces.forEach((aticket) -> {
            m_jtickets.add(new JButtonTicket(aticket, dlsales));
        });  
     
        m_sDialogTicket = null;

        int lsize = mPlaces.size();
        if (lsize > 0) {
            setVisible(true);
        }else{
     ...
     * @return
     */
    public static JEmptyTableList newJDialog(JTicketsBagRestaurantMap ticketsbagshared) {
        
        Window window = getWindow(ticketsbagshared);
        JEmptyTableList mydialog;
        if (window instanceof Frame) { 
            mydialog = new JEmptyTableList((Frame) window, true);
        } else {
            mydialog = new JEmptyTableList((Dialog) window, true);
        } 
    ...
    private class JButtonTicket extends JButton {
        ...
        public JButtonTicket(Place place, DataLogicSales dlsales){
...
// JG Nov 2014
        ...
        private class ActionListenerImpl implements ActionListener {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                m_sDialogTicket = m_Place;
               JEmptyTableList.this.setVisible(false);
