...
public class JTicketsBagRestaurantRes extends javax.swing.JPanel implements EditorRecord {
    ...
    public JTicketsBagRestaurantRes(AppView oApp, JTicketsBagRestaurantMap restaurantmap) {
        ...
        try {
            ...
            Logger.getLogger(JTicketsBagRestaurantRes.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public Object createValue() throws BasicException {
        ...
        if (res[3] != null) {
            data[0] = UUID.randomUUID().toString();
            data[1] = m_process;
            data[2] = "reservation_customers";
            data[3] = res[0];
            data[4] = "id";
            data[5] = customer.getId();
            data[6] = "customer";
            data[7] = g_siteguid;
            data[8] = 0;
            data[9] = 0;
