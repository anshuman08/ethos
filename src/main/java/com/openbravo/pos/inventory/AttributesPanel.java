...
public class AttributesPanel extends JPanelTable2 {
    ...
    private static final long serialVersionUID = 3960639211202421021L;
    ...
    protected void init() {
        ...
        row = new Row(
                ...
                new Field("Countable Attribute", Datas.BOOLEAN, Formats.BOOLEAN, false, true, true),
