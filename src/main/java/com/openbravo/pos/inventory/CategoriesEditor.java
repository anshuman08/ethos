...
public final class CategoriesEditor extends JPanel implements EditorRecord {
    ...
    public CategoriesEditor(AppView app, DirtyManager dirty) {
        ...
        jImageUrl.getDocument().addDocumentListener(dirty);
        jDescription.getDocument().addDocumentListener(dirty);
    ...
    public void writeValueEOF() {
        ...
        jImageUrl.setText(null);
        jDescription.setText(null);
        m_jName.setEnabled(false);
        m_jCategory.setEnabled(false);
        m_jImage.setEnabled(false);
        jImageUrl.setEnabled(false);
...
// Added JG Feb 2017
    ...
    public void writeValueDelete(Object value) {
        ...
        jImageUrl.setText(Formats.STRING.formatValue(cat[4]));
        jDescription.setText(Formats.STRING.formatValue(cat[5]));
        m_jTextTip.setText(Formats.STRING.formatValue(cat[6])); 
        m_jCatNameShow.setSelected(((Boolean)cat[7]));
        m_jCatOrder.setText(Formats.STRING.formatValue(cat[8]));
//        m_process.
        m_jName.setEnabled(false);
        m_jCategory.setEnabled(false);
        m_jImage.setEnabled(false);
...
// Added JG Feb 2017
    ...
    public Object createValue() throws BasicException {
        ...
        cat[4] = jImageUrl.getText();
        cat[5] = jDescription.getText();
        cat[6] = m_jTextTip.getText();
        cat[7] = m_jCatNameShow.isSelected();
        if(m_jCatOrder.getText().length() == 0) {    
            m_jCatOrder.setText(null);        
        }        
        cat[8] = m_jCatOrder.getText();
        cat[9] = g_siteguid;
        //database change log
    ...
    private void initComponents() {
        ...
        jTextimageUrl = new javax.swing.JLabel();
        jImageUrl = new javax.swing.JTextField();
        ...
        jTextimageUrl.setText("Image Url");

        jImageUrl.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jImageUrl.setPreferredSize(new java.awt.Dimension(240, 27));

        jLabel1.setText("Description");

        jDescription.setColumns(20);
        jDescription.setRows(5);
        jDescription.setPreferredSize(new java.awt.Dimension(10, 80));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addContainerGap()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jTextimageUrl)
                                    .addComponent(jLabel1))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(jImageUrl, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                    .addGap(2, 2, 2)
                                    .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(m_jName)
                                .addComponent(m_jTextTip, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTextimageUrl)
                    .addComponent(jImageUrl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jLabel1)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(88, 88, 88)
                        .addComponent(jLblImage, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(m_jImage, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private javax.swing.JTextField jImageUrl;
    ...
    private javax.swing.JLabel jTextimageUrl;
