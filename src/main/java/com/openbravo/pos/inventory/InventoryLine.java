...
public class InventoryLine {
    ...
    public InventoryLine(ProductInfoExt oProduct) {
        this(oProduct, 1.0, oProduct.getPriceBuy());
    }
    ...
    public void setAttributedProductStock(final AttributedProductStock productStock) {
        this.attributedProductStockId = productStock.getId();
        this.attsetid = productStock.getAttributeSetId();
    }
    ...
    public String toString() {
        return "InventoryLine{" + "m_dMultiply=" + m_dMultiply + ", m_dPrice=" + m_dPrice + ", m_sProdID=" + m_sProdID + ", m_sProdName=" + m_sProdName + ", attsetid=" + attsetid + ", attsetinstid=" + attsetinstid + ", attsetinstdesc=" + attsetinstdesc + ", attributedProductStockId=" + attributedProductStockId + ", product=" + product + '}';
    }
