...
public class AuxiliarEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    public AuxiliarEditor(AppView app, DirtyManager dirty) {
        ...
        try {
            ...
            Logger.getLogger(AuxiliarEditor.class.getName()).log(Level.SEVERE, null, ex);
        }
...
m_process= "U";
    ...
    public Object createValue() throws BasicException {
        m_dlSales.insertDatabaseChangeLog2().exec( UUID.randomUUID().toString(),
                m_process,"products_com",id,"id",product,"product",g_siteguid,0,0);
        return new Object[]{
            id,
            product,
            product2,
