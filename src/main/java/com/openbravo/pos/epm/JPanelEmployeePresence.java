...
public class JPanelEmployeePresence extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {
    ...
    public void init(AppView app) throws BeanFactoryException {
        ...
        try {
            ...
            Logger.getLogger(JPanelEmployeePresence.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private class BreakAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent evt) {
            try {
                dlpresencemanagement.StartBreak(app.getAppUserView().getUser().getId(), m_break.getId(),g_siteguid);
