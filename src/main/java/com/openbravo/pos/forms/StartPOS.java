...
import com.ethosmiracle.spring.config.SpringAppConfig;
...
//                // Set the look and feel.
            try {
                ...
                final boolean noActionOnKeyNav = config.getBoolean("selection.disableArrowKeySelection", true);
                UIManager.getLookAndFeelDefaults().put("ComboBox.noActionOnKeyNavigation", noActionOnKeyNav);
// JG 6 May 2013 to multicatch
