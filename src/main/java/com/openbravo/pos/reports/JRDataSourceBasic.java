...
public class JRDataSourceBasic implements JRDataSource {
     ...
     private static final Logger LOG = Logger.getLogger(JRDataSourceBasic.class.getName());
    ...
    public Object getFieldValue(JRField jrField) throws JRException {
        ...
        try {
            final Object ob = m_fields.getField(current, jrField.getName());
//            LOG.log(Level.INFO, "getting data for field: {0} = {1}", new Object[]{jrField.getName(), ob});
            return ob;
