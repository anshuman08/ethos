...
public class PanelReportBean extends JPanelReport {
    ...
    //changes for report
    private static final Logger LOG = Logger.getLogger(PanelReportBean.class.getName());
...
// JG 16 May 12 use diamond inference
    ...
    public void setReport(String report) {
        this.report = report;
        //changed for reports
        LOG.log(Level.INFO, "Activated report: {0}", report);
    }
    ...
    //Changed for reports on 26-12-2017
    /**
     *
     * @return
     */
    protected BaseSentence getSentence() {
        return new StaticSentence(m_App.getSession(), new QBFBuilder(sentence, paramnames.toArray(new String[paramnames
                .size()])), qbffilter.getSerializerWrite(),
