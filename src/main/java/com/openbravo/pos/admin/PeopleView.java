...
public class PeopleView extends JPanel implements EditorRecord {
    ...
    public PeopleView(DataLogicAdmin dlAdmin, DirtyManager dirty) {
        ...
        m_dlAdmin = (DataLogicAdmin) dlAdmin.getBean();
        m_Dirty = dirty;
...
//        System.out.println(m_jcard.getText().length());        
    ...
    public Object createValue() throws BasicException {
        ...
        m_dlAdmin.execDatabaseChangelog( new Object[]{
                                    UUID.randomUUID().toString(),
                                    m_process,
                                    "people",
                                    people[0],
                                    "id",
                                    Formats.STRING.parseValue(m_jName.getText()),
                                    "name",
                                    siteguid,
                                    0,
                                    0});
