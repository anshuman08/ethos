            ...
            try {
                ...
                if (m_App.getActiveCashDateEnd() == null) {
                    new StaticSentence(m_App.getSession()
                        , "UPDATE closedcash SET DATEEND = ?, NOSALES = ?, SITEGUID = ? WHERE HOST = ? AND MONEY = ?"
            ...
            try {
                ...
                m_dlSystem.execInsertCash(
                    new Object[] {m_App.getActiveCashIndex(), 
                        ...
                        m_App.getActiveCashSequence(), 
                        m_App.getActiveCashDateStart(), 
                        m_App.getActiveCashDateEnd(),g_siteguid,0});
                dlSales.insertDatabaseChangeLog2().exec(
                        UUID.randomUUID().toString(),
                        "I",
                        "closedcash",
                        m_App.getActiveCashIndex(),
                        ...
                        0);
                m_dlSystem.execDrawerOpened(
                    new Object[] {m_App.getAppUserView().getUser().getName(),"Close Cash",g_siteguid});
